...
import 'package:job/admin/admin_login.dart';
import 'package:job/pages/bottomnav.dart';
import 'package:job/pages/login.dart';
import 'package:job/service/database.dart';
import 'package:job/service/shared_prefs.dart';
                ...
                child: Column(
                  children: [
                    ...
                    GestureDetector(
                        ...
                        child: Text(
                          "Do you Have an Account Admin ? Login",
                          style: AppWidget.SemiBooldTextFeildStyle(),
                        )),
                    SizedBox(
                      height: 50.0,
